...
reader.onload = function (e) {
	...
	for (i = 0; i<table.length: i++) {
		...
		console.log(table[i][table[0].length])

		document.getElementById("row"+i.toString()+"col1").innerText = table[i][0]
		document.getElementById("row"+i.toString()+"col2").innerText = table[i][1]
		document.getElementById("row"+i.toString()+"img").innerText = table[i][table[0].length]
	}
